...
{
	RCC_voidEnablePeripheral(RCC_APB2,GPIOA);           /* Enable GPIOA peripheral clock. */
	RCC_voidEnablePeripheral(RCC_APB2,SPI1);            /* Enable SPI1 peripheral clock. */

    /* Configure the SPI pins. */
	GPIO_voidSetPinMode(NRF24L01_MOSI_PORT_ID,NRF24L01_MOSI_PIN_ID,GPIO_OUTPUT_10M_AF_PP);
	GPIO_voidSetPinMode(NRF24L01_MISO_PORT_ID,NRF24L01_MISO_PIN_ID,GPIO_INPUT_FLOATING);
	GPIO_voidSetPinMode(NRF24L01_SCK_PORT_ID,NRF24L01_SCK_PIN_ID,GPIO_OUTPUT_10M_AF_PP);
	GPIO_voidSetPinMode(NRF24L01_NSS_PORT_ID,NRF24L01_NSS_PIN_ID,GPIO_OUTPUT_10M_PP);
	GPIO_voidSetPinMode(NRF24L01_CE_PORT_ID,NRF24L01_CE_PIN_ID,GPIO_OUTPUT_10M_PP);
    
    /* Set the NSS pin initial value as HIGH to unselect the nRF chip. */
    GPIO_voidSetPinValue(NRF24L01_NSS_PORT_ID,NRF24L01_NSS_PIN_ID,GPIO_HIGH);
    
    SPI_voidInit();                                                        /* Initialize the SPI peripheral. */
        
    /* Disable the nRF chip while initialization. */
    GPIO_voidSetPinValue(NRF24L01_CE_PORT_ID,NRF24L01_CE_PIN_ID,GPIO_LOW);
    ...
    GPIO_voidSetPinValue(NRF24L01_CE_PORT_ID,NRF24L01_CE_PIN_ID,GPIO_HIGH);
}
...
static void NRF24L01_sendCommand(u8 a_command)
{
    ...
    GPIO_voidSetPinValue(NRF24L01_NSS_PORT_ID,NRF24L01_NSS_PIN_ID,GPIO_LOW);
