...
def write_values(filename, value1, value2, value3):
  content = str(value1) + " " + str(value2) + " " + str(value3) + "\n"  
...
def undistort_img():
    ...
    images = glob.glob('/content/Curved-Lane-Lines/camera_cal/*.jpg')
    ...
    pickle.dump( dist_pickle, open('/content/Curved-Lane-Lines/camera_cal/cal_pickle.p', 'wb') )

def undistort(img, cal_dir='/content/Curved-Lane-Lines/camera_cal/cal_pickle.p'):
...
def cal_Distortion_Test():
  img = cv2.imread('/content/Curved-Lane-Lines/camera_cal/calibration1.jpg')
  dst = undistort(img)
...
def original_Distortion_Test():
  img = cv2.imread('/content/Curved-Lane-Lines/test_images/test3.jpg')
...
def draw_lanes(img, left_fit, right_fit):
    ...
    cv2.fillPoly(color_img, np.int64(points), (0,200,255))
...
def image_Test(path):
  ...
  write_values("dataImage.txt", curverad[0], curverad[1], curverad[2])
...
def vid_pipeline(img):
    ...
    if frame_counter % frame_interval != 0:
        return  img # Return the original frame unprocessed
    ...
    write_values("dataVideo.txt", curverad[0], curverad[1], curverad[2])
...
def video_Test(path):
    ...
    myclip = VideoFileClip(path)#.subclip(40,43)
    # fps = myclip.fps
...
def main():
    ...
    undistort_img()
    # Test Video
    #video_Test('/content/Curved-Lane-Lines/project_video.mp4')
    # Test Image
    image_Test('/content/Curved-Lane-Lines/test_images/test3.jpg') 
